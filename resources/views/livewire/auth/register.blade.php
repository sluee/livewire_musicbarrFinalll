        ...
        <div class="content">
          ...
          <form class="content__form">
            ...
            @enderror
              ...
              <label>
                <input required="" type="text" wire:model='username'>
            ...
            @enderror
              ...
              <label>
                <input required="" type="text" wire:model='location'>
            ...
            <button wire:click='submit'>Sign up</button>
          </form>
          ...
          <div class="content__forgot-buttons">
            ...
            <a href="/login"><button>Already have an account? <span style="color:blue">Login here</span></button></a>
          </div>
        </div>
      </div>
</div>
